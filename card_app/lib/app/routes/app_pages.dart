...
import '../view/reports/reports_tab_view.dart';
import '../view/subscription/subscription_view.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(name: AppRoutes.reports, page: () => ReportsTabView()),
    GetPage(name: AppRoutes.cardManager, page: () => CardManagerView()),
